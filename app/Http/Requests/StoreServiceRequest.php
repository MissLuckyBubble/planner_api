...
class StoreServiceRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'duration.required' => 'Полето продължителност е задължително.',
            'duration.numeric' => 'Полето продължителност трябва да е трябва да е числена стойност.',
            'duration.min' => 'Стойността на продължителност трябва да е по-голяма от 0 min.',
